    ...
    public ArrayList<Cards> selectCardsByCustomer(int idCustomer) throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ...
                card.setCard_type(String.valueOf(Cards.CardType.valueOf(result.getString("card_type"))));
                ...
                card.setStatus(String.valueOf(Cards.Status.valueOf(result.getString("status"))));
